...
export function AppHeader() {
    ...
    return (
        <header className="w-full border-b mb-4 bg-stone-950 text-white">
            <div className="mx-auto flex justify-between items-center h-16 max-w-7xl px-4">
                <div className="flex justify-center items-center">
                    <Link href="/" aria-label="Home" className="group">
                        <svg 
                            xmlns="http://www.w3.org/2000/svg" 
                            className="h-24 w-auto transition-all group-hover:brightness-[0.3] group-hover:contrast-125 group-hover:saturate-0"
